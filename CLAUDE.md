...
- Jev routing eval (live, paid, opt-in; needs `TYPESAFE_API_KEY`; never run by the gate): `./.venv/bin/python scripts/eval_jev.py`. See `evals/README.md`.
