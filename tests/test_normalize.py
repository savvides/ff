...
def test_normalize_name_generational_suffixes():
    ...
    assert normalize_name("Eno Benjamin VII") == "eno benjamin vii" # Not in our suffix list, so stays
...
def test_normalize_name_valid_name_components_retained():
    ...
    assert normalize_name("Jr. Smith") == "smith" # Edge case: "jr" as a token is stripped
